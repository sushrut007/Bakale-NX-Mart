        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-10">
            <div className="md:col-span-1">
              ...
              <p className="text-sm leading-relaxed mb-6" style={{ color: "rgba(253,251,243,0.5)" }}>
                Solapur&apos;s premier destination for premium cut-piece fabrics and readymade garments since decades.
              </p>
              
              <div className="flex items-center gap-4">
                <a href="https://www.instagram.com/bakalenx?igsh=MWttMnljZjdsejY0OQ==" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full flex items-center justify-center transition-all hover:-translate-y-1" style={{ backgroundColor: "rgba(255,255,255,0.1)", color: "white" }}>
                ...
                <a href="https://www.facebook.com/share/1Gx4ES1Dgy/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full flex items-center justify-center transition-all hover:-translate-y-1" style={{ backgroundColor: "rgba(255,255,255,0.1)", color: "white" }}>
                ...
                <a href="https://youtube.com/@bakalenx4329?si=cWQgaEVSZhuKmu5j" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full flex items-center justify-center transition-all hover:-translate-y-1" style={{ backgroundColor: "rgba(255,255,255,0.1)", color: "white" }}>
