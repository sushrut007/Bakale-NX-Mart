...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col" style={{ backgroundColor: "var(--brand-ivory)" }}>
      <Navbar />
      <Hero />
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-3 mb-3">
              ...
              <span className="text-xs font-bold uppercase tracking-[0.25em]" style={{ color: "var(--brand-red)" }}>What We Offer</span>
              <div className="w-2 h-2 rotate-45" style={{ backgroundColor: "var(--brand-red)" }} />
            </div>
            <h2 className="text-4xl md:text-5xl font-black tracking-tight" style={{ color: "var(--brand-maroon)" }}>
              Shop by Category
            </h2>
          </div>
            ...
            {categories.map((cat, i) => (
              ...
              >
                ...
                >
                  ...
                  <h3 className="font-black text-sm mb-1.5 transition-colors group-hover:text-[var(--brand-red)]" style={{ color: "var(--brand-maroon)" }}>
                    {cat.name}
                  </h3>
                  <p className="text-xs leading-relaxed" style={{ color: "var(--brand-warm-grey)" }}>
                    {cat.description}
                  </p>
                </Link>
              </motion.div>
      ...
      {/* Featured Products */}
      <section className="py-24" style={{ backgroundColor: "var(--brand-ivory)" }}>
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
            <div>
              <div className="flex items-center gap-3 mb-2">
                <div className="w-2 h-2 rotate-45" style={{ backgroundColor: "var(--brand-red)" }} />
                <span className="text-xs font-bold uppercase tracking-[0.25em]" style={{ color: "var(--brand-red)" }}>Curated Selection</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black tracking-tight" style={{ color: "var(--brand-maroon)" }}>
                Featured Arrivals
              </h2>
            ...
            <Link
              ...
              style={{ color: "var(--brand-maroon)", borderColor: "var(--brand-maroon)" }}
            >
              View All Products →
            </Link>
          </div>
      ...
      {/* Reviews Section */}
      <section className="py-24" style={{ backgroundColor: "var(--brand-maroon)" }}>
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
            <div>
              <div className="flex items-center gap-3 mb-2">
                <div className="w-2 h-2 rotate-45" style={{ backgroundColor: "var(--brand-red)" }} />
                <span className="text-xs font-bold uppercase tracking-[0.25em]" style={{ color: "var(--brand-red)" }}>Customer Reviews</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black tracking-tight" style={{ color: "var(--brand-ivory)" }}>
            ...
            >
              <div className="text-5xl font-black leading-none mb-1" style={{ color: "var(--brand-red)" }}>
                {overallRating}
              </div>
              <div className="flex gap-0.5 mb-2">
                {[1,2,3,4,5].map(s => (
                  <svg key={s} className="w-3.5 h-3.5" fill={s <= Math.round(overallRating) ? "var(--brand-red)" : "none"} stroke="var(--brand-red)" strokeWidth="1.5" viewBox="0 0 20 20">
                  ...
                  return (
                    <div key={star} className="flex items-center gap-1.5">
                      ...
                      <div className="flex-1 h-1.5 rounded-full overflow-hidden" style={{ backgroundColor: "rgba(255,255,255,0.1)" }}>
                        <div className="h-full rounded-full" style={{ width: `${pct}%`, backgroundColor: "var(--brand-red)" }} />
                      </div>
                    </div>
                  );
                })}
                ...
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                      <span className="font-bold text-sm" style={{ color: "var(--brand-ivory)" }}>{review.name}</span>
                      <span className="text-[10px] shrink-0" style={{ color: "rgba(253,251,243,0.4)" }}>{review.date}</span>
                    </div>
                    <div className="flex gap-0.5 mt-0.5">
                      {Array.from({ length: review.rating }).map((_, s) => (
                        <svg key={s} className="w-3 h-3" fill="var(--brand-red)" viewBox="0 0 20 20">
                          <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                        </svg>
                      ))}
                    </div>
          ...
          <div className="text-center mt-8 flex flex-wrap gap-4 justify-center">
            <Link href="/about" className="inline-flex items-center gap-2 px-6 py-3 rounded-full font-bold text-sm uppercase tracking-wider text-white" style={{ backgroundColor: "var(--brand-red)" }}>
              Read All Reviews
            </Link>
            <a
              ...
              style={{ borderColor: "rgba(253,251,243,0.3)", color: "var(--brand-ivory)" }}
            >
              View on Google Maps →
            </a>
          </div>
      ...
      {/* Store Location */}
      <section className="py-24" style={{ backgroundColor: "var(--brand-blush)" }}>
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-3 mb-3">
                <div className="w-2 h-2 rotate-45" style={{ backgroundColor: "var(--brand-red)" }} />
                <span className="text-xs font-bold uppercase tracking-[0.25em]" style={{ color: "var(--brand-red)" }}>Find Us</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black tracking-tight mb-6" style={{ color: "var(--brand-maroon)" }}>
                Visit Our Store
              </h2>
              <p className="text-base leading-relaxed mb-8" style={{ color: "var(--brand-near-black)" }}>
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={info.title} className="flex gap-4 items-start">
                    <div className="w-12 h-12 rounded-xl flex items-center justify-center text-xl shrink-0" style={{ backgroundColor: "var(--brand-maroon)", color: "var(--brand-ivory)" }}>
                      {info.icon}
                    </div>
                    <div>
                      <h4 className="font-black mb-0.5 text-sm" style={{ color: "var(--brand-maroon)" }}>{info.title}</h4>
                      <p className="text-sm leading-relaxed whitespace-pre-line" style={{ color: "var(--brand-warm-grey)" }}>{info.text}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="h-[420px] w-full rounded-3xl overflow-hidden border-4 shadow-2xl" style={{ borderColor: "var(--brand-maroon)" }}>
              <iframe
      ...
      {/* Footer */}
      <footer className="py-12 border-t" style={{ backgroundColor: "var(--brand-maroon-dark)", borderColor: "rgba(255,255,255,0.08)" }}>
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid md:grid-cols-3 gap-8 mb-10">
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <div className="leading-none">
                  <span className="text-xl font-black tracking-tighter" style={{ color: "var(--brand-ivory)" }}>
            ...
            <div>
              <h4 className="font-black mb-4 text-xs uppercase tracking-wider" style={{ color: "var(--brand-red)" }}>Quick Links</h4>
            ...
            <div>
              <h4 className="font-black mb-4 text-xs uppercase tracking-wider" style={{ color: "var(--brand-red)" }}>Contact</h4>
